...
const KNOWN_CARDS = ['audio', 'bookmark', 'button', 'callout', 'carousel', 'codeblock', 'email-cta', 'email', 'embed', 'file', 'gallery', 'header', 'horizontalrule', 'html', 'image', 'markdown', 'paywall', 'product', 'signup', 'toggle', 'video'];
