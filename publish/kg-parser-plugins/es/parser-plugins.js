...
function fromKoenigCard$1(options) {
...
function fromKoenigCard(options) {
  return function kgCarouselCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
    if (node.nodeType !== 1 || node.tagName !== 'FIGURE') {
...
function createParserPlugins(_options = {}) {
  ...
  return [fromNFTEmbed(), fromMixtape(options), fromKoenigCard$4(), fromKoenigCard$7(), fromWordpressButton(), fromSubstackButton(), kgCalloutCardToCard, kgToggleCardToCard, fromKoenigCard$3(), fromKoenigCard$8(), fromKoenigCard$2(), fromKoenigCard$6(), fromKoenigCard$5(), blockquoteWithChildren, fromBr(), removeLeadingNewline, fromKoenigCard$1(options), fromKoenigCard(options), fromFigureBlockquote(options),
