        ...
        it('Members with expired disable have can_comment: true', async function () {
            ...
            await models.Member.edit({
                commenting: JSON.stringify({
                    disabled: true,
                    disabled_reason: 'Expired disable',
                    disabled_until: pastDate
                })
            }, {id: member.id});
...
describe('Member Commenting Service Behavior', function () {
    ...
    it('Member with invalid disabled_until has can_comment: true (fail open)', async function () {
        ...
        await knex('members').where('id', member.id).update({
            commenting: JSON.stringify({
                disabled: true,
                disabled_reason: 'Disable with invalid date',
                disabled_until: 'invalid-garbage-date'
            })
        });
